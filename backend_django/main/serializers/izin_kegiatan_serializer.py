...
class IzinKegiatanMahasiswaSerializer(serializers.ModelSerializer):
    detail_kegiatan = DetailKegiatanMahasiswaSerializer(many=True)
    ...
    def create(self, validated_data):
        ...
        for detail_kegiatan in detail_kegiatan_data:
            DetailKegiatan.objects.create(izin_kegiatan = izin_kegiatan, **detail_kegiatan)
